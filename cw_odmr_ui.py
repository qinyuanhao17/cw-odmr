...
"}")
        ...
        self.dwell_time_spbx.setProperty("value", 5)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 482, 85))
        ...
        self.acq_time_spbx.setProperty("value", 30)
        self.acq_time_spbx.setObjectName("acq_time_spbx")
        self.gridLayout_6.addWidget(self.acq_time_spbx, 0, 4, 1, 1)
        self.mw_time_spbx = QtWidgets.QSpinBox(self.groupBox_8)
        self.mw_time_spbx.setMaximum(100)
        self.mw_time_spbx.setProperty("value", 30)
        ...
        self.gridLayout_6.addWidget(self.repeat_spbx, 2, 2, 1, 1)
...
"}")
        ...
        self.gridLayout_6.addWidget(self.asg_set_btn, 2, 4, 1, 1)
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 482, 89))
...
"\n"
"}")
        self.asg_start_btn.setIcon(icon5)
...
"}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/my_icons/images/icons/init.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.restore_view_btn.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/my_icons/images/icons/plot.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.plot_data_btn.setIcon(icon9)
        ...
        self.save_plot_data_btn.setIcon(icon10)
        ...
        self.save_plot_btn.setIcon(icon11)
...
"\n"
"}")
        self.clear_repeat_count_btn.setIcon(icon3)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 871, 101))
